...
export const GEMINI_MODEL_INFO = [
  {
    ...
    description: "New Most cost-efficient model supporting high throughput",
  },
  {
  ...
  {
    name: "GEMINI_2_0_FLASH_LITE_PREVIEW_02_05",
  ...
  {
    name: "GEMINI_LIVE_2_5_FLASH_PREVIEW",
    value: "models/gemini-live-2.5-flash-preview",
    description: "Low-latency bidirectional voice and video interactions",
  },
  {
    name: "GEMINI_2_5_FLASH_PREVIEW_NATIVE_AUDIO_DIALOG",
    value: "models/gemini-2.5-flash-preview-native-audio-dialog",
    description:
      "High quality, natural conversational audio outputs, with or without thinking",
  },
  {
    name: "GEMINI_2_5_FLASH_EXP_NATIVE_AUDIO_THINKING_DIALOG",
  ...
  },
  {
    ...
    description: "Precise, conversational image generation and editing",
  },
  {
...
export const IMAGE_GENERATION_MODELS = ["models/gemini-2.5-flash-image"];
